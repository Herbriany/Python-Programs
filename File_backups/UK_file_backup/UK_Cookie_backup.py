...
def main():
    ...
    try: 
        ...
        cookieDay = datetime.fromtimestamp(os.path.getctime('//mkfile2/Ecommerce/Creative Team/Cat 81 - Argos.co.uk/STATIC ASSETS/argosincludes/cookie.htm')).strftime('%Y, %m, %d')
                ...
                if os.path.exists(root_path + '/' + year + '/' + month + '/' + day + '/argos/argosincludes'):
                    for file in os.listdir(root_path + '/' + year + '/' + month + '/' + day + '/argos/argosincludes'):
                        if os.path.isfile(root_path  + '/' + year + '/' + month + '/' + day + '/argos/argosincludes' + '/' + file) and file[:1] != '.':
                            ...
                            print('Moving:  ' +  root_path  + '/' + year + '/' + month + '/' + day + '/argos/argosincludes' + '/' + file)
                            ...
                            if os.path.exists(root_path  + '/' + year + '/' + month + '/' + day + '/argos/argosincludes' + '/m/' + file):
                                ...
                                copyfile(srcfile, destinationfile)
                                print('Moving:  ' +  root_path  + '/' + year + '/' + month + '/' + day + '/argos/argosincludes' + '/m/' + file)
                                print('    To:  ' +  destinationfile)

    os.remove('//mkfile2/Ecommerce/Creative Team/Cat 81 - Argos.co.uk/STATIC ASSETS/argosincludes/cookie.htm')
    f = open('//mkfile2/Ecommerce/Creative Team/Cat 81 - Argos.co.uk/STATIC ASSETS/argosincludes/cookie.htm', 'w')
    f.write('You win!')
    f.close()
